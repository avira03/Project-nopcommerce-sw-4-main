...
public class ElectronicsTest extends BaseTest {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        registerPage.enterEmail("priya9090@gmail.com");
        registerPage.enterPassword("priya1234");
        registerPage.enterConfirmPassword("priya1234");
        ...
        signInPage.emailId("priya9090@gmail.com");
        signInPage.password("priya1234");
        ...
        checkOutPage.enterCompany("Maze");
        checkOutPage.selectCountryFromCountryField("United Kingdom");
        checkOutPage.enterCity("London");
        checkOutPage.enterAddress("Long Drive");
        checkOutPage.enterPostalCode("LU5 6TZ");
        checkOutPage.enterNumber("+4478365766145");
        ...
        paymentInformationPage.enterCardHolderName("Priya Patel");
        paymentInformationPage.enterCardNumber("5368392055488809");
        paymentInformationPage.selectExpiryMonth("07");
        paymentInformationPage.selectExpiryYear("2027");
